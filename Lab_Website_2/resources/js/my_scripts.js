...
function viewStudentStats(id, toggle){
	...
	{
		/*Can't get the new selects to appear no matter what I do*/
		document.getElementById(id).style.visibility = "visbile";
		document.getElementById(id).style.height = "auto";
		/*document.getElementById("student_type").style.visibility = "visibile";
		document.getElementById("student_type").style.height = "auto";
		document.getElementById("student_status").style.visibility = "visibile";
		...
		document.getElementById("grad_select").style.visibility = "visibile";
...
function loadStatsPage(){
		...
		{//Outer for loop iterates over each row
			for(col_counter = 0; col_counter < table.rows[row_counter].cells.length; col_counter++)
			{
				...
				if(row_counter >= 2){
					if(col_counter == 2){
						var buffS = cell_value;
						var oppS = table.rows[row_counter].cells[col_counter+1].innerHTML;
						if(buffS > oppS){
							table.rows[row_counter].cells[col_counter+2].innerHTML = "CU";
							wins++;
						}
						else {
...
function loadPlayersPage(){
	...
	{
		<a href = "#" onclick = "switchPlayers(counter)" >players[counter].name</a>
		document.getElementById("player_selector").options[counter].text.innerHTML = players[counter].name; /*Was not in lab because I was sick, confused by instructions, but this doesn't seem right*/
	}
}
...
function switchPlayers(playerNum){
	...
	document.getElementById("player_img").src.innerHTML = players[playerNum].img;
	document.getElementById("player_img").alt.innerHTML = players[playerNum].alt;
